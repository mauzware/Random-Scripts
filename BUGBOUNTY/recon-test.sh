...
screenshot_path=$doman/screenshots
...
gowitness file -f $subdomain_path/alive.txt -s $screenshot_path/ --no-http

echo -e "${RED} [+] Running Nmap on alive subdomains... ${RESET}"
nmap -iL $subdomain_path/alive.txt -p- -oN $scan_path/nmap_result.txt
